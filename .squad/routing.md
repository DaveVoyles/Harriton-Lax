...
|-----------|---------|----------|
| Architecture, content review, decisions | McNulty | — |
| Offense, defense, tactical docs | Stringer | — |
| Drills, practice plans, progressions | Lester | — |
| Game plans, scouting, adjustments | Omar | — |
| Consistency, formatting, README sync | Bunk | — |
