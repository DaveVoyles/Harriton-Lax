---
description: "Beast Mode 2.0 for Claude: An autonomous agent tuned for the latest Claude models, optimized for complex multi-step reasoning and tool use."
model: Claude 4.5 Sonnet (copilot)
tools:
  [
    "edit/editFiles",
    "runNotebooks",
